    ...
    <div className="flex-1 space-y-8 p-8 max-w-7xl mx-auto">
      ...
      <div>
        <h3 className="text-xl font-semibold text-slate-900 mb-4 flex items-center gap-2">
          <Book className="h-5 w-5 text-[#0731c2]" />
          Getting Started
        </h3>
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2">
                  {category.guides.map((guide, guideIndex) => (
                    <div 
                      key={guideIndex}
                      className="p-4 rounded-lg border border-slate-200 hover:border-[#0731c2] hover:bg-slate-50 transition-colors cursor-pointer group"
                    >
                      <div className="flex items-start gap-3">
                        <div className="p-2 rounded-lg bg-slate-100 text-slate-600 group-hover:bg-blue-100 group-hover:text-[#0731c2] transition-colors">
                          <guide.icon className="h-4 w-4" />
                        </div>
                        <div className="flex-1">
                          <h4 className="font-medium text-slate-900 mb-1 group-hover:text-[#0731c2] transition-colors">
                            {guide.title}
                          </h4>
                          <p className="text-sm text-slate-600">
                            {guide.description}
                        ...
                        <ChevronRight className="h-4 w-4 text-slate-600 group-hover:text-[#0731c2] transition-colors opacity-0 group-hover:opacity-100" />
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-lg bg-blue-100 text-[#0731c2]">
            ...
            <Button 
              variant="outline"
              className="border-[#0731c2] text-[#0731c2] hover:bg-blue-50 hover:border-[#0525a0]"
              asChild
            >
