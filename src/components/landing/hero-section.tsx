    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute bottom-20 right-10 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 dark:opacity-20"
        />
        <motion.div
          animate={{
            y: [0, 30, 0],
          ...
          className="absolute top-40 right-40 w-80 h-80 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 dark:opacity-20"
        />
      </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <div className="relative mx-auto max-w-6xl">
              ...
              <div className="rounded-xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                ...
                <div className="p-8 bg-gradient-to-br from-blue-50 to-blue-50 dark:from-gray-900 dark:to-[#010119]">
                  ...
                  <div className="h-64 bg-white/50 dark:bg-gray-800/50 rounded-lg backdrop-blur" />
                </div>
              </div>
            </div>
          </motion.div>
