...
export function SearchDialog({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 p-0">
        ...
        <div className="p-4 border-b border-slate-200 dark:border-slate-700">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-9 bg-white dark:bg-slate-900/50 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-500 dark:placeholder:text-slate-400 h-12"
              autoFocus
            />
          </div>
        </div>
        ...
        <div className="max-h-[400px] overflow-y-auto">
          {loading ? (
            ...
            <div className="text-center py-12 text-slate-500 dark:text-slate-400">
              <Search className="h-12 w-12 mx-auto mb-4 text-slate-400 dark:text-slate-500 opacity-50" />
              ...
              {results.map((result) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-start gap-3 p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors text-left"
                  >
